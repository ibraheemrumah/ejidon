...
<script type="text/javascript" src="h<?=base_url()?>assets/js/jquery-1.11.0.js"></script>
<script src="<?=base_url()?>assets/js/jquery.js"></script>
<script src="<?=base_url()?>assets/js/bjs/bootstrap.min.js"></script>
							...
							<div class="form-group">
								...
								<?php
                                    ...
                                    for ($c = 0; $c < count($custData); ++$c) {
										...
										<option value="<?php echo $cust_id; ?>" <?php if ($customer_id == $cust_id) {
					...
					<div class="row">
						<div class="col-md-7">
							<div class="form-group">
								...
								<textarea name="remark" class="form-control" style="height: 70px;"><?php echo "The drugs are returned and inventory is updated";?></textarea>
							</div>
						</div>
						<div class="col-md-5"></div>
					</div>
					...
					<div class="row" style="padding-top: 7px;">
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php
                                    $prodData = $this->Constant_model->getDataOneColumn('order_items', 'order_id', $url_sales_id);
                                    for ($p = 0; $p < count($prodData); ++$p) {
                                        $prod_code = $prodData[$p]->product_code;
                                        $prod_name = $prodData[$p]->product_name; ?>
	...
	<table class="table">
		<thead>
			<tr>
		    	...
		    	<th width="10%" style="background-color: #686868; color: #FFF;"><?php echo $lang_condition; ?></th>
