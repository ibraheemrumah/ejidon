			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div id="bkpos_wrp" class="row">
						...
						<div id="bkpos_wrp" class="col-md-6" style="text-align: right;">
							<?php
                                if ($user_role < 3) {
                                    ?>
					...
					<form action="<?=base_url()?>expenses/searchExpenses" method="get" style="margin-top: 7px;">
						<div class="row">
							<div id="bkpos_wrp" class="col-md-2">
							...
							<div class="table-responsive">
								<table class="table table-bordered">
									<thead>
									    ...
									    <th width="10%" style="text-align: right;"><?php echo $lang_amount; ?> (<?php echo $site_currency; ?>)</th>
									    <th id="bkpos_wrp" width="10%"><?php echo $lang_action; ?></th>
									</tr>
								    </thead>
									<tbody>
<?php
    ...
    if ($expRows > 0) {
        ...
        for ($e = 0; $e < count($expData); ++$e) {
			...
			<tr>													
				...
				<td><?php echo $date; ?></td>
				<td style="text-align: right;">N<?php echo number_format($amount, 2); ?></td>
				<td id="bkpos_wrp">
...
?>
									...
									<td colspan="4" >N<?php echo number_format($sumAmount,2); ?> </td>
