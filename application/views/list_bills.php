								...
								<table id="example" class="display" cellspacing="0" width="100%">
									<thead>
										<tr>
										    ...
										    <th width="10%"><?php echo $lang_ref_number; ?></th>
										    ...
										    <th width="14%"><?php echo $lang_action; ?></th>
										</tr>
									</thead>
									<tbody>
<?php
    ...
    if (count($billRows) > 0) {
        ...
        foreach ($billData as $data) {
			...
			<tr>
				...
				<td>
<a href="<?=base_url()?>pos/view_hold?id=<?php echo $sus_id; ?>" style="text-decoration: none; cursor: pointer;" title="Print holding">
