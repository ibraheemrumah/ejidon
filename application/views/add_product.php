...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<form action="<?=base_url()?>products/insertProduct" method="post" enctype="multipart/form-data" id="my-form">
	<div class="row">
		<div class="col-md-12">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="code" class="form-control" maxlength="250" value ="<?php echo (rand(1,999999));?>"readonly  required />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label><?php echo $lang_product_name; ?> <span style="color: #F00">*</span></label>
								<input type="text" name="name" class="form-control" maxlength="250" autocomplete="on"  autofocus />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="retail" class="form-control" maxlength="250"  autocomplete="off" />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
					...
					<!--	<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="required_qty" class="form-control" maxlength="250" autocomplete="off" placeholder="0"/>
							</div>
						</div>-->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<button class="btn btn-primary" id="btn-submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $lang_add; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
							</div>
						</div>
