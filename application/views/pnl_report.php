...
<table id="example" class="display" cellspacing="0" width="100%">
    <thead>
        <tr>
			...
			<th width="10%"><?php echo "Cost Price"; ?> (<?php echo $site_currency; ?>)</th>
            <th width="10%"><?php echo "Sales Price"; ?> (<?php echo $site_currency; ?>)</th>
...
$gen_expense = 0;
  $orderResultDine_in = $this->db->query("SELECT * FROM expenses WHERE created_datetime >= '$start_date' AND created_datetime <= '$end_date' ");
...
$net_profit =0;
$net_profit = $all_profit_amt - $gen_expense ;


    if ($orderRows >= 0) {
        ?>
		<div class="row" style="padding-top: 10px; padding-bottom: 10px; margin-top: 50px; font-size: 18px; letter-spacing: 0.5px;">
			<div class="col-md-3" style="font-weight: bold;"><?php echo "Sales Price"; ?> (<?php echo $site_currency; ?>)</div>
		...
		<div class="row" style="padding-top: 10px; padding-bottom: 10px; font-size: 18px; letter-spacing: 0.5px;">
			<div class="col-md-3" style="font-weight: bold;"><?php echo "Gross Profit"; ?> (<?php echo $site_currency; ?>)</div>
			<div class="col-md-9" style="font-weight: bold;">: <?php echo number_format($all_profit_amt, 2); ?></div>
		</div>
		<div class="row" style="padding-top: 10px; padding-bottom: 10px; font-size: 18px; letter-spacing: 0.5px;">
			<div class="col-md-3" style="font-weight: bold;"><?php echo "All Expenses"; ?> (<?php echo $site_currency; ?>)</div>
			<div class="col-md-9" style="font-weight: bold;">: <?php echo number_format($gen_expense, 2); ?></div>
		</div>
		
		
		<div class="row" style="padding-top: 10px; padding-bottom: 10px; font-size: 18px; letter-spacing: 0.5px;">
			<div class="col-md-3" style="font-weight: bold;"><?php echo "Net Profit"; ?> (<?php echo $site_currency; ?>)</div>
			<div class="col-md-9" style="font-weight: bold;">: <?php echo number_format($net_profit, 2); ?></div>
		</div>
<?php
