	...
	<table class="table">
		...
		<?php
            ...
            for ($pi = 0; $pi < count($poItemData); ++$pi) {
				...
				$po_rec_cost = $poNameData[0]->purchase_price;
				...
				<tr>
					...
					<?php
                        if ($po_rec_qty != 0) {
                            ...
                            ?>
						<input type="text" id="cost_<?php echo $jj; ?>" name="receiveCost_<?php echo $po_item_id; ?>" value="<?php echo $po_rec_cost; ?>" class="form-control" style="width: 80%;" onkeyup="getValue()" />
					<?php
