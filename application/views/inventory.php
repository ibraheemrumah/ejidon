			...
			<div class="panel panel-default">
				...
				<?php
					...
					<div class="row hide-me" style="padding-top: 10px; padding-bottom: 10px; font-size: 18px; letter-spacing: 0.5px; ">
						...
						<div class="row hide-me" style="padding-top: 10px; padding-bottom: 10px; font-size: 18px; letter-spacing: 0.5px; ">
						<div class="col-md-4" style="font-weight: bold;">Total Margin <?php echo $site_currency; ?></div>
						<div class="col-md-8" style="font-weight: bold;">: 
					...
					<div class="row" style="margin-top: 0px;">
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="example" class="display" cellspacing="0" width="100%">
							    <thead>
							    	<tr>
								...
								<?php
                                    if (count($results) > 0) {
                                        foreach ($results as $data) {
                                            ...
                                            $each_cost = $getCostData[0]->retail_price;
											$update = '-';
                                            $categoryData = $this->Constant_model->getDataOneColumn('inventory', 'product_code', $code);
                                            if (count($categoryData) > 0) {
                                                $update = $categoryData[0]->new_qty_date;
