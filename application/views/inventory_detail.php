<?php
	...
	$invNameData = $this->Constant_model->getDataOneColumn('products', 'code', $pcode);
	
    $invName = $invNameData[0]->name;
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo $lang_inventory_for_product; ?> : <?php echo $pcode. " ". $invName; ?></h1>
		</div>
	</div><!--/.row-->
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<h1 class="page-header" style="margin-top: 0px; padding-bottom: 4px; font-size: 30px; margin: 0px 0 11px; color: #0079c0;">
						<?php echo "Fix Inventory Count by Oulets"; ?>
					</h1>
