<?php
    ...
    $ordered_dtm 				= date("$setting_dateformat H:i A", strtotime($orderData[0]->created_datetime));
	...
	$hold_no					= $orderData[0]->ref_number;
   ...
   // }
    ...
    $orderPaymentResult	= $this->db->query("SELECT * FROM order_payments WHERE order_id = '$sus_id' ");
...
<style type="text/css" media="all">
	...
	@media print {
		...
		#wrapper { width: 100%; margin: 0; font-size:11px; font-weight: bold; }
	...
	<table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
	    ...
	    <tr>
		    <td width="100%" align="center">
			    <h2 style="padding-top: 0px; font-size: 22px;"><strong><?php echo $outlet_name; ?></strong></h2>
		...
		<tr>
			<td width="100%">
				...
				<span class="left" style="text-align: left;"><?php echo "Hold No:"; ?> : <?php echo $hold_no; ?></span>
		...
		<tr>
				<span class="left" style="font-size: 15px;"><?php echo "HOLDING"; ?></span>	
			</tr>
    </table>
		...
		<?php
            ...
            for ($i = 0; $i < count($orderItemData); ++$i) {
				...
				<tr>
	                ...
	                <td style="text-align:left; width:130px; padding-bottom: 10px" valign="top"><?php echo $name; ?></td>
