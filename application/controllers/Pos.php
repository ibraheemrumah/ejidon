...
class Pos extends CI_Controller
{
    ...
    public function insertSale()
    {
		...
		<?php
			...
			$cust_status = $custDtaData[0]->status;
			//increment invoice number for fmc customers or pharmacist order
			$new_count =0;
			$id_fix =1;
			if ($cust_status == 1){
				$settingData = $this->Constant_model->getDataOneColumn('site_setting', 'id', 1);
				$inv_count 			= $settingData[0]->inv_count;
				$new_count = $inv_count + 1;
			}
