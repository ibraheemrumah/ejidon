...
class Products extends CI_Controller
{
    ...
    public function product_category()
    {
        ...
        $data['results'] = $this->Products_model->fetch_category_data(0, $page);
    ...
    public function list_products()
    {
        ...
        $data['results'] = $this->Products_model->fetch_product_data(0, $page);
    ...
    public function get_tweets()
	{
	   ...
	   $this->datatables->select('id,code')->from('pv');
    ...
    public function deleteProduct()
    {
		...
		$this->Constant_model->deleteData('inventory', $prod_id);
    ...
    public function updateProduct()
    {
		...
		$required_qty = strip_tags($this->input->post('required_qty'));
